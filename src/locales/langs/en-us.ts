const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'standard_code-set': 'Code Set Management',
    standard_element: 'Data Element Management',
    standard_item: 'Data Item Management',
    'standard_item-mapping': 'Field Mapping Workbench',
    standard_qualifier: 'Qualifier Management',
    'standard_reviewer-config': 'Reviewer Configuration',
