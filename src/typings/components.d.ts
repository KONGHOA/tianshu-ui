...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IconMdiViewGrid: typeof import('~icons/mdi/view-grid')['default']
...
declare global {
  ...
  const IconMdiAccountOutline: typeof import('~icons/mdi/account-outline')['default']
  ...
  const IconMdiShieldCheckOutline: typeof import('~icons/mdi/shield-check-outline')['default']
  const IconMdiViewGrid: typeof import('~icons/mdi/view-grid')['default']
