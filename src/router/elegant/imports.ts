...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  dataingest_instance: () => import("@/views/dataingest_instance/index.vue"),
  dataingest_job: () => import("@/views/dataingest_job/index.vue"),
  ...
  metadata_tag: () => import("@/views/metadata_tag/index.vue"),
  ...
  "standard_code-set": () => import("@/views/standard_code-set/index.vue"),
  standard_element: () => import("@/views/standard_element/index.vue"),
  "standard_item-mapping": () => import("@/views/standard_item-mapping/index.vue"),
  standard_item: () => import("@/views/standard_item/index.vue"),
  standard_qualifier: () => import("@/views/standard_qualifier/index.vue"),
  "standard_reviewer-config": () => import("@/views/standard_reviewer-config/index.vue"),
